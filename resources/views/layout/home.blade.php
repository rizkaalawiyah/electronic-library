...
<html lang="en">
 ...
 <div class="container-fluid main">
    ...
    <nav class="navbar navbar-expand-lg navbar-default">
      ...
      <a class="navbar-brand" href="{{url('/')}}"><img src="{{url('img/logo.png')}}" width="75" height="75"></a>
  ...
  <div class="covertext">
    <div class="col-lg-10" style="float:none; margin:30px auto;">

      <h1 class="title">e - library</h1>
    
      <h3 class="subtitle">an easy way to learn the world </h3>
    </div>
 @if(!Auth::User())
    <div class="col-xs-12 explore">
      <a href="{{ route('login') }}"><button type="button" class="btn btn-lg explorebtn">Get Started</button></a>
    </div>
 @else
    <div class="col-xs-12 explore">
      <a href="{{ url('/index') }}"><button type="button" class="btn btn-lg explorebtn">Get Started</button></a>
    </div>
@endif
  </div>
